...
defmodule Seeds do
  ...
  def run do
    ...
    a = Repo.insert!(%User{ name: "Jeff", email: "jeff@example.com" })
    b = Repo.insert!(%User{ name: "Jacob", email: "jacob123@example.com" })
    c = Repo.insert!(%User{ name: "William", email: "coconuts1040@gmail.com" })
